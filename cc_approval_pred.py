...
def make_prediction():
    # 从本地加载模型
    model = joblib.load("C:/Users/22001/Desktop/Credit-card-approval-prediction-classification-main/saved_models/gradient_boosting/gradient_boosting_model.sav")
